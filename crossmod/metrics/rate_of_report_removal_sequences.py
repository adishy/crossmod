...
class RateOfReportRemovalSequences:
    def __init__(self, subreddit):
        ...
        self.output_directory = os.path.join(CrossmodConsts.METRICS_OUTPUT_DIRECTORY, "rate_of_report_removal_sequences")
    ...
    def create_plot(self):
        ...
        line_plot.set_title(f'Number of comments removed by Moderators after it was reported\n by Crossmod each day since\n {self.start.strftime("%b %d %Y")} for r/{self.subreddit}')
...
RateOfReportRemovalSequences("Futurology").save_plot()